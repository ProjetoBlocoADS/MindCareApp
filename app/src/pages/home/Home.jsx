...
const conteudo = {
    home: {
        ...
        cards: [{ image: banner, label: 'Acompanhamento', alt: 'ilustração' }, { image: banner, label: 'Acompanhamento', alt: 'ilustração' }, ]
    }
}
...
export default function Home({ openMenu, closeSideMenu }) {
    ...
    return (<div className="home">
        ...
        <div className="">
            ...
            <Descricao titulo={conteudo.home.descricao[0].titulo} descricao={conteudo.home.descricao[0].descricao} />
            <Descricao titulo={conteudo.home.descricao[1].titulo} descricao={conteudo.home.descricao[1].descricao} />

            <div className="carrossel">
                {conteudo.home.cards.map(card => <CardHome
                    image={card.image}
                    label={card.label}
                    alt={card.alt}
                />)}
